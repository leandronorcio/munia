...
function CreateFollowNotificationIcon() {
  return <div className="absolute -bottom-2 right-0 rounded-full bg-gradient-to-r from-pink-400 to-red-500 p-2">
    <SvgProfile width={18} height={18} stroke="white" />
  </div>
}
function LikeNotificationIcon() {
  return <div className="absolute -bottom-2 right-0 rounded-full bg-gradient-to-r from-violet-400 to-violet-500 p-2">
    <SvgHeart width={18} height={18} stroke="white" />
  </div>
}
function MentionNotificationIcon() {
  return <div className="absolute -bottom-2 right-0 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 p-2">
    <SvgAtSign width={18} height={18} stroke="white" />
  </div>
}
function CreateCommentNotificationIcon() {
  return <div className="absolute -bottom-2 right-0 rounded-full bg-gradient-to-r from-blue-400 to-blue-500 p-2">
